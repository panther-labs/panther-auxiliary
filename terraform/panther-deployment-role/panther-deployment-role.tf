...
resource "aws_iam_policy" "deployment_policy2" {
...
resource "aws_iam_role_policy_attachment" "deployment_policy2" {
  role       = aws_iam_role.deployment_role.name
  policy_arn = aws_iam_policy.deployment_policy2.arn
}

resource "aws_iam_policy" "deployment_policy3" {
...
resource "aws_iam_role_policy_attachment" "deployment_policy3" {
  role       = aws_iam_role.deployment_role.name
  policy_arn = aws_iam_policy.deployment_policy3.arn
}

resource "aws_iam_policy" "deployment_policy4" {
...
resource "aws_iam_role_policy_attachment" "deployment_policy4" {
  role       = aws_iam_role.deployment_role.name
  policy_arn = aws_iam_policy.deployment_policy4.arn
}
